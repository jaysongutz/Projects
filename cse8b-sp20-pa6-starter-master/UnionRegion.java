...
//////////////////////////// 80 columns wide //////////////////////////////////
/**
 * This is a concrete class that extends BaseRegion and defines a union
...
class UnionRegion extends BaseRegion {
	...
	/**
	 * Constructor for UnionRegion
	 *
	 * @param reg1 - BaseRegion representing the first shape 
	 * @param reg2 - BaseRegion representing the second shape
	 */
	public UnionRegion(BaseRegion reg1, BaseRegion reg2) {
		this.name = "Union Region between " + reg1.name +
					" and " + reg2.name;
		this.reg1 = reg1;
		this.reg2 = reg2;
 	}
	...
	/**
	 * Method to check if a point lies on this union
	 */
	public boolean contains(Point p) {
		if (this.reg1.contains(p) == true ||
			this.reg2.contains(p) == true) {
			return true;
		}
		else {
			return false;
