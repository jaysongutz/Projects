...
//////////////////////////// 80 columns wide //////////////////////////////////
/**
 * This is a concrete class that extends BaseRegion and defines a subtraction
 * between two BaseRegion subclasses
 *
 * @author Jayson Gutierrez
 */
class SubtractRegion extends BaseRegion {
	 ...
	 */
	public SubtractRegion(BaseRegion reg1, BaseRegion reg2) {
		this.name = "Subtract Region between " + reg1.name +
					" and " + reg2.name;
		this.reg1 = reg1;
		this.reg2 = reg2;
	}
	...
	public boolean contains(Point p) {
		if (reg1.contains(p) && !reg2.contains(p)) {
			return true;
		}
		else {
			return false;
